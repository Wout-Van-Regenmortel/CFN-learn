...
def make_hint(sol, nmb_left_out):
    dropped = random.sample(range(0, 81), nmb_left_out)
    # print(dropped)
...
validation_set_path = '/home/wout/CFN-learn/Other/LatinSquare/validation/instance.json'
