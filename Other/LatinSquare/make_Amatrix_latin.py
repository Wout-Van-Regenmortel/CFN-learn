...
path = '/home/wout/CFN-learn/Other/LatinSquare/Instances/Tests/4x4/instance.json'
...
data = onehotencoder.fit_transform(list_data).toarray() #je haalt de duplicates er niet uit wout!
data = np.array(data, dtype=int)
# print(data[0])
